    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500">
      ...
      <div className="bg-white rounded-2xl shadow-xl p-12 w-full max-w-2xl mx-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-lg">Choose your role to login</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            ...
            <p className="text-gray-600 mb-4">
              Login to access your library account and manage borrowings
            </p>
          ...
          >
            ...
            <p className="text-gray-600 mb-4">
              Login to manage the library system and monitor activities
            </p>
